...
var reducer = (state, action) => {
  switch (action.type) {
    ...
    case "PLAYER_MOVE": {
      ...
      const isMoveRight = [
        move == null ? void 0 : move.san,
        move == null ? void 0 : move.lan,
      ].includes((state == null ? void 0 : state.nextMove) || "");
...
var useChessPuzzle = (puzzle, onSolve, onFail) => {
  ...
  useEffect(() => {
    var _a2, _b, _c;
    if (
      ((_a2 = game == null ? void 0 : game.history()) == null
        ? void 0
        : _a2.length) <=
      0 + (puzzle.makeFirstMove ? 1 : 0)
    ) {
      return;
    }
    if (game.history().length % 2 === (puzzle.makeFirstMove ? 0 : 1)) {
      dispatch({
        ...
        payload: {
          move:
            ((_c =
              (_b = gameContext == null ? void 0 : gameContext.game) == null
                ? void 0
                : _b.history({ verbose: true })) == null
              ? void 0
              : _c.pop()) ?? null,
          onSolve,
          onFail,
...
// src/components/ChessPuzzle/parts/Root.tsx
var PuzzleRoot = ({ puzzle, onSolve, onFail, children }) => {
...
var Root = ({ puzzle, onSolve, onFail, children }) => {
  return /* @__PURE__ */ React3.createElement(
    ChessGame.Root,
    { fen: puzzle.fen, orientation: getOrientation(puzzle) },
    /* @__PURE__ */ React3.createElement(
      PuzzleRoot,
      { puzzle, onSolve, onFail },
      children,
    ),
  );
};
...
var PuzzleBoard = ({ ...rest }) => {
  ...
  return /* @__PURE__ */ React4.createElement(ChessGame2.Board, {
...
var Hint = ({ children, asChild, showOn = defaultShowOn2 }) => {
  const puzzleContext = useChessPuzzleContext();
  if (!puzzleContext) {
    throw new Error("PuzzleContext not found");
  }
