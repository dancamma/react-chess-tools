...
// src/hooks/useChessGame.ts
var useChessGame = ({ fen, orientation: initialOrientation } = {}) => {
...
// src/components/ChessGame/parts/Root.tsx
var Root = ({ fen, orientation, children }) => {
  ...
  if (isCheck) {
    game.board().forEach((row) => {
      return row.forEach((square) => {
        if (
          (square == null ? void 0 : square.type) === "k" &&
          (square == null ? void 0 : square.color) === info.turn
        ) {
...
// src/components/ChessGame/parts/Board.tsx
var Board = ({ customSquareStyles, ...rest }) => {
  ...
  const onPromotionPieceSelect = (piece) => {
    var _a;
    if (
      (promotionMove == null ? void 0 : promotionMove.from) &&
      (promotionMove == null ? void 0 : promotionMove.to) &&
      piece
    ) {
      ...
      return makeMove({
        ...
        to: promotionMove.to,
        promotion:
          ((_a = piece == null ? void 0 : piece[1]) == null
            ? void 0
            : _a.toLowerCase()) || "q",
      });
    }
  ...
  return /* @__PURE__ */ React4.createElement(Chessboard, {
    customSquareStyles: {
