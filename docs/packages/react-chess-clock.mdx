...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <code>'auto' | 'mm:ss' | 'ss.d' | 'hh:mm:ss'</code>
      </td>
      <td>auto</td>
    ...
    <tr>
      ...
      <td>
        <code>(milliseconds: number) =&gt; string</code>
      </td>
      <td>-</td>
      <td>Custom time formatting function</td>
    </tr>
  </tbody>
</table>
...
- `hh:mm:ss` - Hours, minutes and seconds (1:05:00)
...
/* Style when a player has timed out */
