...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Board orientation (white or black perspective)</td>
    </tr>
    <tr>
      <td>
...
Create and manage game state outside of the component tree. This hook creates isolated state, unlike `useChessGameContext` which accesses shared state from a provider.
...
See [Theming](?path=/docs/packages-react-chess-game-theming--docs) for theme customization options.
