...
Moves accept either **UCI** (from-square + to-square) or **SAN** (algebraic notation) — both are validated:
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <code>(puzzleContext: ChessPuzzleContextType) =&gt; void</code>
      </td>
      <td>-</td>
      <td>Called when puzzle is solved (receives full puzzle context)</td>
    </tr>
    <tr>
      <td>
        <code>onFail</code>
      ...
      <td>-</td>
      <td>Called on wrong move (receives full puzzle context)</td>
    </tr>
    <tr>
      <td>
