...
interface WorkerOptions {
  workerPath: string; // Path to stockfish.js worker
  throttleMs?: number; // Throttle interval (ms) for analysis updates
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Which side is at the bottom/left of the bar</td>
    </tr>
    <tr>
      <td>
      ...
      <td>Show numerical eval text</td>
    </tr>
    <tr>
      <td>
        <code>asChild</code>
      ...
      <td>Render as custom element (Radix Slot)</td>
    </tr>
    <tr>
      <td>
        <code>className</code>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>all</td>
      <td>Maximum number of lines to show</td>
    </tr>
    <tr>
      <td>
        <code>onLineClick</code>
      </td>
      <td>
        <code>(rank: number, pv: PrincipalVariation) =&gt; void</code>
      </td>
      <td>-</td>
      <td>Callback when a line is clicked</td>
    </tr>
    <tr>
      <td>
        <code>asChild</code>
